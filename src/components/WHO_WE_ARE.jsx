...
const WHO_WE_ARE = () => {
    return (
        ...
        <div className='how-we-are max-w-full h-auto flex-col dark:bg-black text-white flex justify-center items-center lg:flex-row lg:mx-12 mt-0  '>
                ...
                <div className='lg:w-1/2 w-full   flex justify-center  items-center flex-col h-80  lg:mt-0 mt-12  lg:ml-4'>
                    <h2 className='w-full lg:h-14 h-auto flex justify-start items-start text-amber-500 text-3xl font-title underline'>How We Are</h2>
                    <p className=' text-gray-400 font-body text-start capitalize tracking-tight h-96 '>
