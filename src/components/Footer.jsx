  ...
  return (
    <div className="w-full lg:h-[400px] h-auto mt-6 text-black  bg-Footer-pattern bg-center ">
      <div
        ...
        style={{ backgroundColor: "#034760d4 " }}
      >
        <div className="w-full h-[75%] px-10 py-6 flex  lg:flex-row  flex-col   ">
          <div className="lg:w-1/4 w-full flex flex-col items-start  mr-12 lg:mb-0 mb-4  ">
            <h3 className="font-body text-blue-title mb-6 ">New House</h3>
            <p className="font-body text-gray-300 mb-6 text-start ">
              CitiLights brings wide range of choice, steadily updated property
              list and market trend for you to figure out your right decision.
            </p>
          ...
          <div className="lg:w-1/4 w-full flex flex-col items-start lg:mb-0 mb-4  ">
            <h3 className="font-body text-blue-title mb-6 ">
              Featured Property
            </h3>
          ...
          <div className="lg:w-1/4 w-full  flex flex-col items-start  px-2 lg:mb-0 mb-4 ">
            <h3 className="font-body text-blue-title mb-6 ">Contact info</h3>
            <div className="w-full  flex flex-col  ">
              <div
                className="w-full  h-8 flex justify-start items-start rounded-lg text-sm mb-4  "
                style={{ backgroundColor: "#2d3b40" }}
              >
                <span
                  className=" w-12 h-full rounded-l-lg flex justify-center items-center text-sm font-body"
                  style={{ backgroundColor: "#1a1d1e" }}
                >
                  <FaMapMarkerAlt color="#fff" />
                </span>
                <span className=" w-full h-full rounded-l-lg flex justify-center items-center font-body text-[12px] ml-2 text-gray-300">
                  376 Baker Street, New York
                </span>
              </div>
              <div
                className="w-full  h-8 flex justify-start items-start rounded-lg text-sm mb-4  "
                style={{ backgroundColor: "#396d9770" }}
              >
                <span
                  className=" w-12 h-full rounded-l-lg flex justify-center items-center text-sm font-body"
                  style={{ backgroundColor: "#1a1d1e" }}
        ...
        <div
          className="w-full  lg:h-[25%] h-auto flex justify-between items-center  px-10 py-2 lg:flex-row flex-col   "
          style={{ backgroundColor: "rgb(12 25 30 / 38%)" }}
        >
          ...
          <div className="lg:w-1/2 w-full  h-auto flex flex-col justify-center lg:items-end items-center ">
            <h2 className="text-2xl text-gray-300 font-body mb-[-8px] mt-3">
              New House
            </h2>
            <div className="flex justify-center items-center h-full ">
              <GiSpookyHouse size={40} color="#fff" />{" "}
              <span className="text-gray-300 font-body pt-4">
                Real Estate Company
              </span>
            </div>
          </div>
