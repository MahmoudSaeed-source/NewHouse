...
const Card = ({ house }) => {
  ...
  return (
        <div className='w-full h-full bg-cyan-900 text-white flex items-center flex-col mb-2 rounded-xl hover:bg-gradient-to-r from-sky-500 to-indigo-500  hover:shadow-md relative' >
              ...
              <div className='text-[8px] flex justify-start items-center w-full h-4 over-hidden'><FaMapMarkerAlt size={15} color="red" /> {house.address}</div>
              ...
              <div className="w-full h-12 flex items-center justify-start ">
                    <div className='w-[33.3%] h-full flex items-center justify-center text-sm border-2 rounded-bl-lg border-r-0'>
                          <TbArrowBigUpLineFilled /> {house.sqft}
                    </div>
                    <div className='w-[33.3%] h-full flex items-center justify-center text-lg border-2  '>
                          <BiBed />  {house.beds} 
                    </div>
                    <div className='w-[33.4%] h-full flex items-center justify-center text-sm  border-2 px-2 rounded-br-lg  border-l-0'>
