...
const HousesForRent = () => {
  ...
  const HousesForSale = Houses.houseForRent;
          ...
          {Houses.isLoding && (
            <div className="w-full h-auto flex justify-center items-center py-24">
              <PropagateLoader color="#38bdf8" />
                  ...
                  <div className="w-full h-auto overflow-auto  p-0 flex justify-center items-center flex-col dark:border-gray-600 :border-gray-100 ">
            {!Houses.isLoding &&
            FormSearchHouses.length <= 0 &&
            currentProducts.length > 0 ? (
              <>
                <div className="w-full h-16 flex justify-start items-center text-blue-title capitalize lg:px-12 px-4">
                  houses Results:
                  <span className="font-bold text-gray-700 ml-2">
                    {HousesForSale.length}
                  </span>
                </div>
          ...
          <div className="Featured-Properties w-full h-auto flex flex-col lg:px-4 px-0">
            ...
            <div className="houses w-full h-auto flex flex-col justify-start items-center">
              <ul className=" w-full flex-col  flex  justify-start items-center  ">
                {Houses.houseForRent.slice(133, 137).map(
                  (house) =>
                    house.photo && (
                      <li
